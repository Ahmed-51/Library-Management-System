    ...
    public partial class IssueBook : System.Web.UI.Page
    {
        ...
        void returnBook()
        {
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    cmd = new SqlCommand("update Book_Inventory set current_stock = current_stock+1 WHERE book_id='" + TextBox1.Text.Trim() + "'", con);
                    cmd.ExecuteNonQuery();
                    con.Close();
        ...
        bool checkIfBookExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from Book_Inventory WHERE book_id='" + TextBox1.Text.Trim() + "' AND current_stock >0", con);
        ...
        bool checkIfMemberExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from Members WHERE id='" + TextBox2.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
        ...
        void getNames()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select book_name from Book_Inventory WHERE book_id='" + TextBox1.Text.Trim() + "'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
                ...
                cmd = new SqlCommand("select full_name from Members WHERE id='" + TextBox2.Text.Trim() + "'", con);
